...
JNIEXPORT jlong
JNICALL
Java_com_example_urvish_androidnativeapinn_MainActivity_initModel(
        JNIEnv *env,
        jobject /* this */,
...
JNIEXPORT jfloat
JNICALL
Java_com_example_urvish_androidnativeapinn_MainActivity_startCompute(
        JNIEnv *env,
        jobject /* this */,
        jlong _nnModel,
        jfloat inputValue1,
...
JNIEXPORT void
JNICALL
Java_com_example_urvish_androidnativeapinn_MainActivity_destroyModel(
        JNIEnv *env,
        jobject /* this */,
        jlong _nnModel) {
    SimpleModel* nn_model = (SimpleModel*) _nnModel;
